...
namespace GungeonAPI
{
	...
	public class MobiusShopCofferInteractable : SimpleInteractable, IPlayerInteractable
	{
		...
		public void Interact(PlayerController interactor)
		{
			...
			if (flag3)
			{
				...
				if (flag6)
				{
					TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 2f, "How?", interactor.characterAudioSpeechTag, false, TextBoxManager.BoxSlideOrientation.NO_ADJUSTMENT, false, false);
				}
				else
				{
		...
		{  
			...
			TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, -1f, $"{SaveAPIManager.GetPlayerStatValue(CustomTrackedStats.MOBIUS_CHEST_MONEY)} casings swirl inside the Möbius Coffer tempting you, it is barely open, but maybe you could sneak a hand inside and take some.", interactor.characterAudioSpeechTag, false, TextBoxManager.BoxSlideOrientation.NO_ADJUSTMENT, true, false);
		    ...
		    GameUIRoot.Instance.DisplayPlayerConversationOptions(interactor, null, $"<Reach inside the Möbius Coffer>", "<Walk Away>");
			...
			if (flag2)
			{
				...
				RoRItems.pulls += 1;
				TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 2f, "You quickly pull out your loot, your hand intact and your sanity just a little bit worse for wear", interactor.characterAudioSpeechTag, false, TextBoxManager.BoxSlideOrientation.NO_ADJUSTMENT, false, false);
			...
			if (SaveAPIManager.GetPlayerStatValue(CustomTrackedStats.MOBIUS_CHEST_MONEY) == 0 || RoRItems.pulls > 4)
			{
