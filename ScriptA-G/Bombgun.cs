...
namespace Mod
{
    ...
    public class Bomblauncher : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Bomberman", "bomberman");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:bomberman", "ror:bomberman");
            gun.gameObject.AddComponent<Bomblauncher>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Blast Away!");
            gun.SetLongDescription("Explosion!");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "bomberman_idle_001", 8);
            ...
            gun.encounterTrackable.EncounterGuid = "Bomblauncher";
            ...
            projectile.gameObject.AddComponent<BombProjectile>();
        ...
        private void AtgSalvo(Projectile projectile)
        {
            PlayerController owner = base.gun.CurrentOwner as PlayerController;
            float value = UnityEngine.Random.Range(-15f, 15f);
            GameObject gameObject = SpawnManager.SpawnProjectile(projectile.gameObject, gun.sprite.WorldCenter, Quaternion.Euler(0f, 0f, (base.gun == null) ? 0f : base.gun.CurrentAngle + value), true);
            ...
            if (flag)
            {
                ...
                component.baseData.speed = 6.5f;
                component.SetOwnerSafe(owner, "Player");
                component.baseData.damage = 100f;
                component.baseData.force = 100f;
                component.baseData.range = 20f;
                component.AdditionalScaleMultiplier = 4.5f;
                component.AdjustPlayerProjectileTint(Color.HSVToRGB(1f, 0.05f, 0.7f), 5, 0f);
