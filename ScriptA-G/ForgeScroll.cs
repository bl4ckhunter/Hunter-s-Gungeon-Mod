...
namespace Items
{
	...
	internal class ForgeScroll : PlayerItem
	{
		...
		{
			string name = "Forge escape route";
			string resourceName = "ClassLibrary1/Resources/Forge";
			GameObject gameObject = new GameObject();
			ForgeScroll ForgeScroll = gameObject.AddComponent<ForgeScroll>();
			ItemBuilder.AddSpriteToObject(name, resourceName, gameObject);
			string shortDesc = "To the Forge!";
...
;
			ForgeScroll.SetupItem(shortDesc, longDesc, "ror");
			ForgeScroll.AddPassiveStatModifier(PlayerStats.StatType.AdditionalItemCapacity, 1f, StatModifier.ModifyMethod.ADDITIVE);
			ForgeScroll.quality = PickupObject.ItemQuality.EXCLUDED;
		}
		...
		{
			this.flag = false;
			if (GameManager.Instance.Dungeon.tileIndices.tilesetId == GlobalDungeonData.ValidTilesets.FORGEGEON || GameManager.Instance.Dungeon.tileIndices.tilesetId == GlobalDungeonData.ValidTilesets.HELLGEON)
