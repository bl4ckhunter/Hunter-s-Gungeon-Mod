...
namespace Mod
{
    ...
    public class GeoStaff : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Geomancer's Staff", "Staff");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:geomancer's_staff", "ror:geomancer's_staff");
            gun.gameObject.AddComponent<GeoStaff>();
            ...
            gun.encounterTrackable.EncounterGuid = "GeoStaff";
        ...
        private void Sound(Projectile obj)
        {
            ...
            base.StartCoroutine(this.HandleTriggerRockSlide(man, Mines_Cave_In, aimpoint - new Vector2 (1,1)));
