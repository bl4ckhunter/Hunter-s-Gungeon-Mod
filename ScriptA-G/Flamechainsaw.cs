...
namespace Mod
{
    ...
    public class Flamechainsawgun : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Rocket Propelled Flaming Chainsaws", "rocketsaw");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:rocket_propelled_flaming_chainsaws", "ror:flamesaw");
            gun.gameObject.AddComponent<Flamechainsawgun>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("I Loathe Acronyms");
            gun.SetLongDescription("He went to live in a swamp and invented a flaming rocket-propelled chainsaw launcher.They said he was crazy. But I say... yeah, OK, he was a few baguettes short of a full bakery, but now I can shoot flaming rocket-propelled chainsaws, so who are we to judge? \n -- Sam Stone");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "rocketsaw_idle_001", 8);
            ...
            gun.encounterTrackable.EncounterGuid = "Flamesawlauncher";
            //This block of code helps clone our projectile. Basically it makes it so things like Shadow Clone and Hip Holster keep the stats/sprite of your custom gun's projectiles.
            //This block of code helps clone our projectile. Basically it makes it so things like Shadow Clone and Hip Holster keep the stats/sprite of your custom gun's projectiles.
            Projectile projectile = UnityEngine.Object.Instantiate<Projectile>(gun.DefaultModule.projectiles[0]);
            projectile.gameObject.SetActive(false);
            projectile.SetProjectileSpriteRight("rocketsaw_projectile_001", 28, 7);
            projectile.gameObject.AddComponent<FlamingChainsaw>();
            HomingModifier homingModifier = projectile.gameObject.GetOrAddComponent<HomingModifier>();
            homingModifier.HomingRadius = 100f;
            homingModifier.AngularVelocity = 150f;
            ...
            FireOnReloadSynergyProcessor fireOnReloadSynergyProcessor = (PickupObjectDatabase.GetById(37) as Gun).gameObject.GetComponent<FireOnReloadSynergyProcessor>();
            gun.gameObject.AddComponent(fireOnReloadSynergyProcessor);
        ...
        protected void Update()
        {
            ...
            if (gun.CurrentOwner)
            {
                base.gun.ClipShotsRemaining = 0;
                if (man.PlayerHasActiveSynergy("Serious Business"))
                    { 
                    FireOnReloadSynergyProcessor fireOnReloadSynergyProcessor = gun.gameObject.GetComponent<FireOnReloadSynergyProcessor>();
                    fireOnReloadSynergyProcessor.RequiresNoSynergy = true; }
                else
                {
                    FireOnReloadSynergyProcessor fireOnReloadSynergyProcessor = gun.gameObject.GetComponent<FireOnReloadSynergyProcessor>();
                    fireOnReloadSynergyProcessor.RequiresNoSynergy = false;
                }
