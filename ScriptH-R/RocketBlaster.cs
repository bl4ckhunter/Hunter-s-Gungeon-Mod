...
namespace Mod
{
    ...
    public class RocketBlaster : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Booster Gun", "blastoffer");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:booster_gun", "ror:booster_gun");
            gun.gameObject.AddComponent<RocketBlaster>();
            ...
            gun.SetupSprite(null, "blastoffer_idle_001", 8);
            ...
            gun.encounterTrackable.EncounterGuid = "BlastOffer";
            ...
            projectile.gameObject.AddComponent<EnemyRocketProjectile>();
