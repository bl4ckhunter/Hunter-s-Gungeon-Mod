...
namespace Mod
{
    ...
    public class MoxyMwanSMG : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Critical Fail", "krit");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:critical_fail", "ror:critical_fail");
            gun.gameObject.AddComponent<MoxyMwanSMG>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Slippery When Wet");
            gun.SetLongDescription("This gun's manufacturer is renown for its stylish design and its use of exotic ammunition types. This one uses electrified ammunition. \n\n" + "The previous owner must've really loved makeup couse this thing is literally smeared in it, watch out that you don't lose your grip on it while reloading");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "krit_idle_001", 8);
            ...
            gun.encounterTrackable.EncounterGuid = "CriticalFail";
    ...
    public override void OnPostFired(PlayerController player, Gun gun)
        ...
        protected void Update()
        {
            if (gun.CurrentOwner)
            {
                ...
                if (man.PlayerHasActiveSynergy("Shock And Awe") && !man.HasPickupID(Gungeon.Game.Items["ror:slag_nebula"].PickupObjectId) && !addedgun)
                { man.inventory.AddGunToInventory(Gungeon.Game.Items["ror:slag_nebula"] as Gun, true);
                   addedgun = true; 
        ...
        {   if(UnityEngine.Random.value < 0.35f && !player.PlayerHasActiveSynergy("Shock And Awe"))
            {
