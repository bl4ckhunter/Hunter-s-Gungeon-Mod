...
namespace Mod
{
    ...
    public class MissileMassacre : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Macross", "dark");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:macross", "ror:macross");
            gun.gameObject.AddComponent<MissileMassacre>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Rocket Barrage");
            gun.SetLongDescription("Blowing things up has never been so much fun! - UNDERWHELMING IF DUCT TAPED TO OTHER GUNS, DUCT TAPING GUNS TO IT IS FINE.");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "dark_idle_001", 8);
            ...
            gun.SetBaseMaxAmmo(380);
            // Here we just set the quality of the gun and the "EncounterGuid", which is used by Gungeon to identify the gun.
            gun.quality = PickupObject.ItemQuality.C;
            gun.encounterTrackable.EncounterGuid = "Missile Swarm";
            //This block of code helps clone our projectile. Basically it makes it so things like Shadow Clone and Hip Holster keep the stats/sprite of your custom gun's projectiles.
            Projectile projectile = UnityEngine.Object.Instantiate<Projectile>(gun.DefaultModule.projectiles[0]);
            projectile.gameObject.AddComponent<SwarmMissiles>();
            projectile.gameObject.SetActive(false);
            FakePrefab.MarkAsFakePrefab(projectile.gameObject);
            UnityEngine.Object.DontDestroyOnLoad(projectile);
            gun.DefaultModule.projectiles[0] = projectile;
            projectile.sprite.scale = new Vector2(5f, 0.2f);
        ...
        private void AtgSalvo()
        {
            ...
            float value = UnityEngine.Random.Range(-15f, 15f);
            GameObject gameObject = SpawnManager.SpawnProjectile(projectile.gameObject, gun.sprite.WorldCenter, Quaternion.Euler(0f, 0f, (base.gun == null) ? 0f : base.gun.CurrentAngle + 180f + value), true);
            ...
            if (flag)
            {
                ...
                exploder.explosionData.damage = 7f * owner.stats.GetStatValue(PlayerStats.StatType.Damage);
