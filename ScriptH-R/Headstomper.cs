...
namespace Mod
{
        ...
        public class Headstomper : PassiveItem
        {
            ...
            ItemBuilder.AddPassiveStatModifier(headstomper, PlayerStats.StatType.DodgeRollDamage, 7, StatModifier.ModifyMethod.MULTIPLICATIVE);
        ...
        {
            base.Pickup(player);
            PickupObject obj = PickupObjectDatabase.GetById(414);
            obj.CanBeDropped = false;
            if( !base.Owner.HasPassiveItem(414) )
{
                player.GiveItem("live_ammo"); }
