...
namespace Mod
{
    ...
    public class Wand : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Magic Wand", "wand");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:magic_wand", "ror:magic_wand");
            gun.gameObject.AddComponent<Wand>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("True Magic");
            gun.SetLongDescription("The magic wand of one of the few magic users in the gungeon that refused to turn to gunjury. The magic blasts this wand fires deal no direct damage but while in a pinch it can turn enemies into chickens or at least knock them back its main use is transmodifying enemy projectiles into firendly ones.");
            ...
            gun.encounterTrackable.EncounterGuid = "wand";
            ...
            gun.barrelOffset.localPosition += new Vector3(0.65f, 0.1f, 0f);
        ...
        private void Wand1()
        {
            ...
            Projectile projectile2 = ((Gun)global::ETGMod.Databases.Items[61]).DefaultModule.projectiles[0];
            GameObject gameObject = SpawnManager.SpawnProjectile(projectile2.gameObject, gun.sprite.WorldCenter, Quaternion.Euler(0f, 0f, base.gun.CurrentAngle), true);
            ...
            if (flag8)
            {
                ...
                component.baseData.force = 200f;
                    BulletTransModifier hungry = component.gameObject.AddComponent<BulletTransModifier>();
                    hungry.MaximumBulletsEaten = 5;
                component.Owner = man;
                component.Shooter = man.specRigidbody;
                if (component.gameObject.GetComponent<HungryProjectileModifier>())
                {
                    Destroy(component.gameObject.GetComponent<HungryProjectileModifier>());
    ...
    public override void OnPostFired(PlayerController player, Gun gun)
        ...
        protected void Update()
        {
            if (gun.CurrentOwner)
            {
                ...
                if (man1.HasPassiveItem(815) || man1.HasPickupID(Gungeon.Game.Items["magic_bullets"].PickupObjectId) || man1.HasPickupID(Gungeon.Game.Items["ror:magic_shells"].PickupObjectId) && !man1.HasPickupID(Gungeon.Game.Items["ror:starletite_cannon"].PickupObjectId) && !addedgun)
                { man1.inventory.AddGunToInventory(Gungeon.Game.Items["ror:starletite_cannon"] as Gun, true);
                    addedgun = true;
                }
