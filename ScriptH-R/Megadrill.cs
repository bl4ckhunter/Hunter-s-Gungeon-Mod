...
namespace Mod
{
    ...
    public class Megadrill : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Megadrill", "megadrill");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:megadrill", "ror:megadrill");
            gun.gameObject.AddComponent<Megadrill>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Pierce the Heavens!");
            gun.SetLongDescription("Someone built this to try and dig their way out of the gungeon, straight through the planet's core. If you've ever made it past the dragun you know were they ended up, but this remains nontheless an impressive piece of machinery and one of the few weapons in the gungeon that can hit enemies through walls.");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "megadrill_idle_001", 8);
            // ETGMod automatically checks which animations are available.
            // The numbers next to "shootAnimation" determine the animation fps. You can also tweak the animation fps of the reload animation and idle animation using this method.
            gun.SetAnimationFPS(gun.shootAnimation, 24);
            // Every modded gun has base projectile it works with that is borrowed from other guns in the game. 
            // The gun names are the names from the JSON dump! While most are the same, some guns named completely different things. If you need help finding gun names, ask a modder on the Gungeon discord.
            gun.AddProjectileModuleFrom(PickupObjectDatabase.GetById(807) as Gun, true, false);
            ...
            gun.encounterTrackable.EncounterGuid = "Megadrill";
        ...
        public override void PostProcessProjectile(Projectile projectile)
        {
            ...
            if (man.HasPassiveItem(815) && !man.HasPickupID(Gungeon.Game.Items["anti-materiel_ammo"].PickupObjectId))
