...
namespace Mod
{
    ...
    public class Heartlance : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Heartlance", "flamer");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:heartlance", "ror:heartlance");
            gun.gameObject.AddComponent<Heartlance>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Holy Fire");
            gun.SetLongDescription("Blessed Relic");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "flamer_idle_001", 8);
            ...
            gun.encounterTrackable.EncounterGuid = "Heartlance";
            //This block of code helps clone our projectile. Basically it makes it so things like Shadow Clone and Hip Holster keep the stats/sprite of your custom gun's projectiles.
            //This block of code helps clone our projectile. Basically it makes it so things like Shadow Clone and Hip Holster keep the stats/sprite of your custom gun's projectiles.
            Projectile projectile = UnityEngine.Object.Instantiate<Projectile>(gun.DefaultModule.projectiles[0]);
            projectile.SetProjectileSpriteRight("heartlance_projectile_001", 50, 15, 10, 5);
            ...
            projectile.gameObject.AddComponent<HeartlanceProjectile>();
    ...
    public override void OnPostFired(PlayerController player, Gun gun)
        ...
        protected void Update()
        {
            if (gun.CurrentOwner)
            {
                ...
                Material outlineMaterial = SpriteOutlineManager.GetOutlineMaterial(this.gun.sprite);
                outlineMaterial.SetColor("_OverrideColor", new Color(10f, 6f, 0f));
            }
