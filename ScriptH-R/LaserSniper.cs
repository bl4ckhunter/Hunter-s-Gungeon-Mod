...
namespace Mod
{
    ...
    public class IonRifle : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Ion Rifle", "lasersniper");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:ion_rifle", "ror:ion_rifle");
            gun.gameObject.AddComponent<IonRifle>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Hold Steady Towards Enemy");
            gun.SetLongDescription("The signature weapon of an elite sniper stranded a forsaken planet, successful active reload greatly empowers the first shot of the clip and reduces reload time, failing resets reload time and consumes 10 ammo.");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "lasersniper_idle_001", 8);
            ...
            gun.AddProjectileModuleFrom(PickupObjectDatabase.GetById(705) as Gun, true, false);
            // Here we just take the default projectile module and change its settings how we want it to be.
            gun.DefaultModule.ammoCost = 1;
            gun.DefaultModule.angleVariance = 0f;
            gun.DefaultModule.shootStyle = ProjectileModule.ShootStyle.SemiAutomatic;
            gun.DefaultModule.sequenceStyle = ProjectileModule.ProjectileSequenceStyle.Random;
            gun.reloadTime = 2.36f; 
            gun.DefaultModule.cooldownTime = 0.35f;
            gun.DefaultModule.numberOfShotsInClip = 10;
            gun.SetBaseMaxAmmo(200);
            // Here we just set the quality of the gun and the "EncounterGuid", which is used by Gungeon to identify the gun.
            gun.quality = PickupObject.ItemQuality.B;
            gun.encounterTrackable.EncounterGuid = "Ion Rifle1a";
        ...
        public override void PostProcessProjectile(Projectile projectile)
        {
            ...
            if (man.CurrentGun.ClipShotsRemaining == man.CurrentGun.ClipCapacity)
            {
                if (!activereloadsuccess)
                {
                    man.CurrentGun.ammo -= 10;
                    man.CurrentGun.reloadTime = 2.36f * man.stats.GetStatValue(PlayerStats.StatType.ReloadSpeed);

                }
                if (activereloadsuccess)
                {   
                    if (!man.PlayerHasActiveSynergy("Deadeye"))
                    {
                        Projectile projectile1 = ((Gun)ETGMod.Databases.Items[508]).DefaultModule.projectiles[0];
                        GameObject gameObject = SpawnManager.SpawnProjectile(projectile1.gameObject, base.gun.barrelOffset.position, Quaternion.Euler(0f, 0f, (man.CurrentGun == null) ? 0f : base.gun.CurrentAngle), true);
                    ...
                    if (man.CurrentGun.reloadTime > 0.60f)
                    {
                        man.CurrentGun.reloadTime -= 0.32f * man.stats.GetStatValue(PlayerStats.StatType.ReloadSpeed);
                    }
                }
                if (man.PlayerHasActiveSynergy("Deadeye"))
                {
