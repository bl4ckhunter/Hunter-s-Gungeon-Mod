...
namespace Mod
{
    ...
    public class Basher : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Basher", "basher");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:basher", "ror:basher");
            gun.gameObject.AddComponent<Basher>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Double Barrel Action");
            gun.SetLongDescription("This shotgun's manufacturer is renown for making excellent if old fashioned guns, dodgerolling over a bullet makes your bullets critical and your firerate much faster for a brief amount of time as well as making you shoot straight from your ammo pool");
            ...
            gun.encounterTrackable.EncounterGuid = "Bashera1";
    ...
    public override void OnPostFired(PlayerController player, Gun gun)
        ...
        private void StopRoutine(Gun arg1, Gun arg2, bool arg3)
        {
            ...
            { this.onCooldown = false;
              PlayerController man = base.gun.CurrentOwner as PlayerController;
                base.gun.DefaultModule.cooldownTime = 0.30f;
