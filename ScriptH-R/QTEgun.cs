...
namespace Mod
{
    ...
    public class QTEgun : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Neon Sign", "neongun");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:neon_sign", "ror:neon_sign");
            gun.gameObject.AddComponent<QTEgun>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Live Guns!");
            gun.SetLongDescription("It's just an old bar sign, but the gundead don't know that. Only fires upon successful active reloads");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "neongun_idle_001", 8);
            ...
            gun.encounterTrackable.EncounterGuid = "QTERifle1a";
            ...
            gun.barrelOffset.localPosition = new Vector3(1.5625f, 0.8f, 0f);
        ...
        protected void Update()
        {
            ...
            if (gun.CurrentOwner)
            {
                ...
                if (!gun.IsReloading && !HasReloaded)
                {
                    ...
                    outlineMaterial.SetColor("_OverrideColor", Color.HSVToRGB(rancolor, 1f, 100f));
                    gun.reloadTime = UnityEngine.Random.Range(0.5f, 1.5f);
        ...
        private void StealthEffect()
        {
            ...
            Projectile projectile1 = (PickupObjectDatabase.GetById(702) as Gun).DefaultModule.projectiles[0];
            GameObject gameObject = SpawnManager.SpawnProjectile(projectile1.gameObject, base.gun.barrelOffset.position, Quaternion.Euler(0f, 0f, (base.gun.CurrentOwner.CurrentGun == null) ? 0f : base.gun.CurrentAngle), true);
            ...
            if (flag)
            {
                ...
                component.AdjustPlayerProjectileTint(Color.HSVToRGB(rancolor, 1f, 1f), 10);
                component.AdditionalScaleMultiplier = UnityEngine.Random.Range(0.5f, 4.5f);
                component.baseData.damage *= UnityEngine.Random.Range(5f, 10f);
                ExplosiveModifier modifier = component.gameObject.AddComponent<ExplosiveModifier>();
                modifier.explosionData = (PickupObjectDatabase.GetById(593) as Gun).DefaultModule.projectiles[0].gameObject.GetComponent<ExplosiveModifier>().explosionData;
