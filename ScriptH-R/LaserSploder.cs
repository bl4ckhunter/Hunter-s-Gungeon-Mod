...
public class LaserSploder : GunBehaviour
{
    ...
    public static void Add()
    {
        ...
        Gun gun = ETGMod.Databases.Items.NewGun("LaserSploder", "Lasersploder");
        // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
        Game.Items.Rename("outdated_gun_mods:lasersploder", "ror:lasersploder");
        gun.gameObject.AddComponent<LaserSploder>();
        //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
        gun.SetShortDescription("Laser == Explosion!?!?!");
        gun.SetLongDescription("Who said beam weapons are no fun? (laser causes explosions when hitting enemies, duct taping guns to it is fine but it doesn't work when duct-taped to other guns");
        // This is required, unless you want to use the sprites of the base gun.
        // That, by default, is the pea shooter.
        // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
        // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
        // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
        gun.SetupSprite(null, "Lasersploder_idle_001", 8);
        ...
        gun.encounterTrackable.EncounterGuid = "Lasersploder111";
        ...
        gun.barrelOffset.localPosition += new Vector3(1.15f, 0.15f, 0f);
    ...
    private void Yank(Projectile arg1, SpeculativeRigidbody spec, bool bol)
    {
        if (!onCooldowncollide)
        {
            ...
            boomer.explosionData.damage = 8f * man.stats.GetStatValue(PlayerStats.StatType.Damage);
            boomer.IgnoreQueues = true;
            Exploder.Explode(spec.UnitCenter, boomer.explosionData, Vector2.zero, null, false, CoreDamageTypes.None, false);
    ...
    private BeamController BeginFiringBeam(Projectile projectileToSpawn, PlayerController source, float targetAngle, Vector2? overrideSpawnPoint)
    {
        ...
        component.AdjustPlayerProjectileTint(Color.black.WithAlpha(Color.black.a / 2f), 5, 0f);
    ...
    {
        Vector2 vector = (overrideSpawnPoint == null) ? source.CenterPosition : overrideSpawnPoint.Value;
        beam.AdjustPlayerBeamTint(Color.yellow.WithAlpha(Color.black.a / 2f), 5, 0f);
