...
namespace Mod
{
    ...
    public class TedioreSMG : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Excellerator", "TedioreSMG");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:excellerator", "ror:excellerator");
            gun.gameObject.AddComponent<TedioreSMG>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Hunter Seeker");
            gun.SetLongDescription("This gun's manufacturer is renown for making guns so poor that it's faster and safer to throw the gun away than reload them, this one will hunt your enemies down and shoot lasers at them.");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "TedioreSMG_idle_001", 8);
            ...
            gun.AddProjectileModuleFrom(PickupObjectDatabase.GetById(685) as Gun, true, false);
            ...
            gun.encounterTrackable.EncounterGuid = "TedioreSMG";
    ...
    public override void OnPostFired(PlayerController player, Gun gun)
        ...
        public override void OnReloadPressed(PlayerController player, Gun gun, bool bSOMETHING)
        {
            if (gun.ClipShotsRemaining == 0 && !this.unused)
            {
                ...
                if (man1.HasPassiveItem(815) || man1.HasPickupID(Gungeon.Game.Items["ror:launcher"].PickupObjectId))
                {
                    PlayerController man = base.gun.CurrentOwner as PlayerController;
