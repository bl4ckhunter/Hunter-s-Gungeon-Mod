...
namespace Mod
{
    ...
    public class Sickle : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            gun.encounterTrackable.EncounterGuid = "Sickle";
            ...
            projectile.SetProjectileSpriteRight("Sikle_projectile_0001", 21, 20, null, null);
            gun.barrelOffset.localPosition += new Vector3(0.7f, -0.3f, 0f);
    ...
    public override void OnPostFired(PlayerController player, Gun gun)
        {
            ...
            AkSoundEngine.PostEvent("Play_WPN_makarov_shot_01", gameObject);
        }
        ...
        private void Prices(PlayerController user)
        {
            this.m_buffedTarget = user;
            this.m_temporaryModifierPrice = new StatModifier();
            this.m_temporaryModifierPrice.statToBoost = PlayerStats.StatType.GlobalPriceMultiplier;
            this.m_temporaryModifierPrice.amount = 0f;
            this.m_temporaryModifierPrice.modifyType = StatModifier.ModifyMethod.MULTIPLICATIVE;
            user.ownerlessStatModifiers.Add(this.m_temporaryModifierPrice);
            user.stats.RecalculateStats(user, false, false);
        }

        private void Curse(PlayerController user)
        {
            this.m_buffedTarget = user;
            this.m_temporaryModifierCurse = new StatModifier();
            this.m_temporaryModifierCurse.statToBoost = PlayerStats.StatType.Curse;
            this.m_temporaryModifierCurse.amount = 3f;
            this.m_temporaryModifierCurse.modifyType = StatModifier.ModifyMethod.ADDITIVE;
            user.ownerlessStatModifiers.Add(this.m_temporaryModifierCurse);
            user.stats.RecalculateStats(user, false, false);
        }
        private void RemoveTemporaryBuff()
        {
            this.m_buffedTarget.ownerlessStatModifiers.Remove(this.m_temporaryModifierCurse);
            this.m_buffedTarget.ownerlessStatModifiers.Remove(this.m_temporaryModifierPrice);
            this.m_buffedTarget.stats.RecalculateStats(this.m_buffedTarget, false, false);
            this.m_temporaryModifierCurse = null;
            this.m_temporaryModifierCurse = null;
        }
