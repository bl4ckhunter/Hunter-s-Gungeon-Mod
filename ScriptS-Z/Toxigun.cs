...
namespace Mod
{
    ...
    public class ToxicGun : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Injector gun", "Toxichand");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:injector_gun", "ror:injector_gun");
            gun.gameObject.AddComponent<ToxicGun>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Poisoned Gun");
            gun.SetLongDescription("Intoxicating Power, straight into your veins. \n\n\n" + "(Firing this gun increases poisons you, damage and projectile size scale based on poison meter, when poison meter is above 30% projectiles poison targets, reloading removes poison)");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "Toxichand_idle_001", 8);
            ...
            gun.AddProjectileModuleFrom(PickupObjectDatabase.GetById(151) as Gun, true, false);
            ...
            gun.encounterTrackable.EncounterGuid = "Toxichand";
            ...
            projectile.baseData.damage *= 0.3f;
        ...
        public override void PostProcessProjectile(Projectile projectile)
        {
            ...
            projectile.AdditionalScaleMultiplier = 1 + (man.CurrentPoisonMeterValue * 1.5f);
            projectile.baseData.damage *= 1 + (man.CurrentPoisonMeterValue * 4f);
            if(man.CurrentPoisonMeterValue > 0.4f)
            { projectile.gameObject.AddComponent<PoisonModifier>();}
            projectile.AdjustPlayerProjectileTint(Color.HSVToRGB(0.33333f, 1f, 0.5f +(man.CurrentPoisonMeterValue)), 5, 0f);
        }
        ...
        public override void OnPostFired(PlayerController player, Gun gun)
        {
            ...
            AkSoundEngine.PostEvent("Play_ENM_lizard_bubble_01", gameObject);
            PlayerController Man = gun.CurrentOwner as PlayerController;            
            if(Man.CurrentPoisonMeterValue <= 0.95f)
            { Man.CurrentPoisonMeterValue += 0.22f; }
            else{
                ...
                goopManagerForGoopType.TimedAddGoopCircle(Man.specRigidbody.UnitCenter, 1f, 0.8f, false);
            }
        }
        ...
        public override void OnReloadPressed(PlayerController player, Gun gun, bool bSOMETHING)
        {
            ...
            {
                HasReloaded = false;
                Man.CurrentPoisonMeterValue = 0f;
