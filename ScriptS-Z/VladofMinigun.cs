...
namespace Mod
{
    ...
    public class Revolution : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Revolution", "Revolution");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:revolution", "ror:revolution");
            gun.gameObject.AddComponent<Revolution>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Spin free of your shackles");
            gun.SetLongDescription("Fires faster the longer you keep firing, ammo refills at the start of every floor\n\n" + "Comrade [Redacted] addressing you! The people can overcome their oppressors only by banding together in large numbers, just like the high rate - of - fire of [Redacted] weapons! Except the people are BULLETS!\n\n" + "-- Excerpt from [Redacted] Corporation Radio Advert");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "Revolution_idle_001", 8);
            ...
            gun.RateOfFireMultiplierAdditionPerSecond = 1f;
            gun.SetBaseMaxAmmo(800);
            // Here we just set the quality of the gun and the "EncounterGuid", which is used by Gungeon to identify the gun.
            gun.quality = PickupObject.ItemQuality.A;
            gun.encounterTrackable.EncounterGuid = "Revolution";
            ...
            gun.barrelOffset.localPosition += new Vector3(2f, 0.2f, 0f);
            ...
            projectile.AdditionalScaleMultiplier = 0.45f;
    ...
    public override void OnPostFired(PlayerController player, Gun gun)
        ...
        {   
            ...
            { this.hasbeenadded = true;
               ...
               man.OnNewFloorLoaded += ReAmmo;
            }
            
                if (gun.CurrentOwner)
            {
                PlayerController man1 = base.gun.CurrentOwner as PlayerController;
                if (man1.PlayerHasActiveSynergy("Winter War") && !man1.HasPickupID(Gungeon.Game.Items["ror:mortar"].PickupObjectId) && !addedgun)
                { man1.inventory.AddGunToInventory(Gungeon.Game.Items["ror:mortar"] as Gun, true);
                    addedgun = true;
                }
        ...
        private void ReAmmo(PlayerController obj)
        {
            if(gun.CurrentOwner && base.gun != null)
            { gun.GainAmmo(800); }
        }
