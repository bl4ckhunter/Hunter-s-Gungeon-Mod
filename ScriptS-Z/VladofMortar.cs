...
namespace Mod
{
    ...
    public class VladofMortar : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Mortar", "Mortar");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:mortar", "ror:mortar");
            gun.gameObject.AddComponent<VladofMortar>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Make It Rain!");
            gun.SetLongDescription("Projectles explode on target point and pierce terrain and enemies, technically controller compatible but i make no promises there\n\n" + " Rapid Fire Explosions!");
            // This is required, unless you want to use the sprites of the base gun.
            // That, by default, is the pea shooter.
            // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
            // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
            // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
            gun.SetupSprite(null, "Mortar_idle_001", 8);
            ...
            gun.encounterTrackable.EncounterGuid = "Mortar";
            ...
            gun.barrelOffset.localPosition += new Vector3(0.0f, 0.5f, 100f);
            ...
            ExplosiveModifier explosiveModifier = projectile.gameObject.GetComponent<ExplosiveModifier>();
            explosiveModifier.explosionData.force = 0f;
            explosiveModifier.explosionData.doScreenShake = false;
        ...
        private void UpdateReticlePosition()
        {
            ...
            base.gun.DefaultModule.projectiles[0].baseData.range = Vector2.Distance(this.aimpoint, player.CenterPosition);
        }
    ...
    public override void OnPostFired(PlayerController player, Gun gun)
        {
            ...
            AkSoundEngine.PostEvent("Play_WPN_m79grenadelauncher_shot_01", gameObject);
        }
        ...
        {   
            if (gun.CurrentOwner)
            {
                ...
                if (man1.PlayerHasActiveSynergy("Winter War")&& !man1.HasPickupID(Gungeon.Game.Items["ror:revolution"].PickupObjectId) && !addedgun)
                { man1.inventory.AddGunToInventory(Gungeon.Game.Items["ror:revolution"] as Gun, true);
                    addedgun = true;
                }
        ...
        {  
            if (gun.IsReloading && this.HasReloaded)
            {
                ...
                AkSoundEngine.PostEvent("Play_WPN_m79grenadelauncher_reload_01", base.gameObject);
