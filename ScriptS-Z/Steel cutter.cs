...
public class SteelCutter : GunBehaviour
{
    ...
    public static void Add()
    {
        ...
        Gun gun = ETGMod.Databases.Items.NewGun("Oscilloscope", "Steelcutter");
        // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
        Game.Items.Rename("outdated_gun_mods:oscilloscope", "ror:oscilloscope");
        gun.gameObject.AddComponent<SteelCutter>();
        //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
        gun.SetShortDescription("Up and down");
        gun.SetLongDescription("Wub Wub");
        // This is required, unless you want to use the sprites of the base gun.
        // That, by default, is the pea shooter.
        // SetupSprite sets up the default gun sprite for the ammonomicon and the "gun get" popup.
        // WARNING: Add a copy of your default sprite to Ammonomicon Encounter Icon Collection!
        // That means, "sprites/Ammonomicon Encounter Icon Collection/defaultsprite.png" in your mod .zip. You can see an example of this with inside the mod folder.
        gun.SetupSprite(null, "Steelcutter_idle_001", 8);
        ...
        gun.encounterTrackable.EncounterGuid = "Oscilloscope";
        ...
        gun.barrelOffset.localPosition += new Vector3(0.375f, 0.3f, 0f);
    ...
    public IEnumerator HandleFireShortBeam(Projectile projectileToSpawn, PlayerController source)
    {
        ...
        {
            this.color = UnityEngine.Random.ColorHSV(0.3f, 0.3f, 1f, 1f, 1.02f, 1.02f);
            elapsed += BraveTime.DeltaTime; float floaty = (float)Math.Sin(elapsed * 5) *45;
            this.ContinueFiringBeam(beam, source, base.gun.CurrentAngle + floaty, gun.barrelOffset.position, projectileToSpawn, color);
            yield return null;
        }
        this.CeaseBeam(beam);
        yield break;
    ...
    private void Yank(Projectile arg1, SpeculativeRigidbody spec, bool bol)
    {
        if (!onCooldowncollide)
        {
            ...
            if (spec.healthHaver != null && !onCooldowncollide)
            {
                ...
                PlayerController man = base.gun.CurrentOwner as PlayerController;
                spec.healthHaver.ApplyDamage(10f * man.stats.GetStatValue(PlayerStats.StatType.Damage), Vector2.zero, "Erasure", CoreDamageTypes.None, DamageCategory.Normal, true, null, false);
            }
